    ...
    { headerName: "Frecuencia", field: "numberFrecuency" },
    {
      ...
      cellRendererFramework: (params) => (
        <div>
          <button
            type="button"
            className="btn btn-sm btn-primary p-2 mx-auto my-auto d-block text-capitalize"
          >
            Editar
          </button>
        </div>
    ...
    <div className="row min-vh-100">
      <div className="col-lg-12 col-md-10 col-12 mx-auto">
        <h3 className="mt-3 mb-0 text-center mb-6">
          {" "}
          Configuración de alertas para vencimiento de documentación de
          vehículos{" "}
        </h3>
          ...
          <MarcaDeAgua1>
            <div className="row">
              <div className="col-12 col-md-4 mt-4">
                <label className="form-floating input-group input-group-dynamic mb-3">
                  {" "}
                  Tipo de documento
                </label>
                <Controller
              ...
              <div className="col-12 col-md-4 mt-4">
                <div className="input-group input-group-dynamic">
                  <label className="form-floating input-group input-group-dynamic ms-2">
                    {" "}
                    Frecuencia (Hora/as): <span className="text-danger">
                      *
                    </span>{" "}
                  </label>
                  <input
        ...
        <CalendarModal>
          <MarcaDeAgua1>
            <div className="d-flex justify-content-center mt-10">
              <p>
                Los documentos: "seguro de póliza", vencerán el día 05/05/2022{" "}
              </p>
            </div>
