...
const TraspasoElementosBodegasScreen = () => {
  ...
  const columnDefs = [
    { headerName: "Codigo", field: "number" },

    { headerName: "Nombre", field: "item" },

    { headerName: "Marca", field: "item2" },

    { headerName: "Serial", field: "number" },

    { headerName: "Id único", field: "number" },

    { headerName: "Cantidad", field: "numberFrecuency" },
    ...
    { headerName: "Valor unitario", field: "precio" },

    { headerName: "Valor total", field: "precio" },
  ];
    ...
    <div className="row min-vh-100">
      <div className="col-lg-12 col-md-10 col-12 mx-auto">
        <h3 className="mt-3 mb-0 text-center mb-6">
          {" "}
          Traspaso de elementos en bodegas
        </h3>
          ...
          <MarcaDeAgua1>
            <div className="row" hidden={page === 2}>
              <div className="col-12 col-md-4 mt-2">
                <div className="input-group input-group-dynamic">
                  <label className="form-floating input-group input-group-dynamic ms-2">
                    {" "}
                    Código:{" "}
                    <span className="text-danger" {...register("code")}>
                      *
                    </span>{" "}
                  </label>
                  <input
              ...
              <div className="col-12 d-flex justify-content-center mt-6 mb-5">
                <label className="form-floating input-group input-group-dynamic ms-4 my-2">
                  {" "}
                  Quien traslada:{" "}
                </label>
                <Controller
              ...
              <div className="col-12 col-md-4 mt-2">
                <div className=" input-group input-group-dynamic">
                  <label className="form-floating input-group input-group-dynamic ms-2">
                    {" "}
                    Bodegas de salida <span className="text-danger">
                      *
                    </span>{" "}
                  </label>
                  <Controller
              ...
              <div className="row mt-5">
                ...
                <div className="d-flex justify-content-center mt-2">
                  <textarea
                    ...
                    type="text"
                    placeholder="Por favor agregue concepto"
                  />
                </div>
              </div>
            ...
            <div className="row col-12" hidden={page === 1}>
              ...
              <div className="d-flex justify-content-end gap-4 mt-5">
                <button
                  className={`btn bg-gradient-secondary text-capitalize ${
                    page === 1 && "d-none"
                  }`}
                  type="button"
                  title="Send"
