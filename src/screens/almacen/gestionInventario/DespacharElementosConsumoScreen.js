  ...
  return (
    <div className="row min-vh-100">
      <div className="col-lg-12 col-md-12 col-12 mx-auto">
        ...
        >
          <MarcaDeAgua1>
          <h3 className="mt-3 text-start mb-3 fw-light ms-3">Despachar Elementos para Consumo</h3>
            ...
            <div className="row ms-1 justify-content-start">
              <div className="col-12 col-md-3">
                <div className="mb-3">
                  ...
                  <input
                    type="search"
                    id="consecutivoDespacharElementosConsumo"
                    name="consecutivo"
                    minlength="2"
                    maxlength="15"
                    defaultValue={"25225"}
                    className="form-control border border-terciary rounded-pill px-3"
                    {...register("consecutivoDespacharElementosConsumo", {
                      required: true,
                    })}
                  />
                  {errors.consecutivoDespacharElementosConsumo && (
