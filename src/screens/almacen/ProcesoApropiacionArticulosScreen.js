...
export const ProcesoApropiacionArticulosScreen = () => {
    ...
    const [rowDataEntradaRela] = useState([
      ...
      {    TipoEn: "Embargo",
      Consec:"4465462254asd",
      Exped: "20-02-02-00115",
    ...
    const columnEntradaRela = [
      { headerName: "Tipo de Entrada", field: "TipoEn", minWidth: 150, maxWidth: 200 },
      {
                ...
                <div className="col-12 col-md-4">
                  <div className=" input-group input-group-dynamic flex-column col-12 col-md-6 mt-3">
                    <label htmlFor="exampleFormControlInput1">
                      Fecha de Apropiacion: <span className="text-danger">*</span>
                    </label>
                    <Controller
                      name="fechaIngreso"
                      control={control}
...
export default ProcesoApropiacionArticulosScreen;