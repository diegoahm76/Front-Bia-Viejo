...
const ReprogramarSolicitudVehiculoScreen = () => {
  ...
  return (
    <div className="row min-vh-100 ">
      <div className="col-12 mx-auto">
        <h3 className="mt-3 mb-0 text-center mb-6">Reprogramar solicitud</h3>
        <form
...
export default ReprogramarSolicitudVehiculoScreen;
