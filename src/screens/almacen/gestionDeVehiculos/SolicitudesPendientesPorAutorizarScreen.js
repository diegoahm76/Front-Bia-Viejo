...
const SolicitudesPendientesPorAutorizarScreen = () => {
          ...
          <div id="myGrid" className="ag-theme-alpine mt-3">
            ...
            <form className="row">
              {viewData && (
                <>
                  ...
                  <div className="d-flex justify-content-end flex-column flex-md-row gap-2 mt-4">
                    <button
                      className="btn bg-gradient-primary text-capitalize text-white"
                      type="button"
                    >
                      Verificar compatibilidad con solicitudes en cola de espera
                    </button>
                  ...
                  <div className="d-flex justify-content-start flex-column flex-lg-row gap-2">
                  ...
                  <div className="d-flex justify-content-end flex-column flex-sm-row gap-2 mt-4">
                    <button
                      className="btn bg-gradient-secondary text-capitalize text-white"
                      type="button"
                      onClick={() => {
                        setTipoAccion("Autorizar solicitud");
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        setTipoAccion("Rechazar solicitud");
                        dispatch(activeModalAction());
                      }}
                    >
                      Rechazar
            ...
            <CalendarModal>
              <div className="row">
                ...
                {tipoAccion === "Autorizar solicitud" && (
                  <>
                    <h5 className="font-weight-bolder mt-4">Coordinador</h5>
...
export default SolicitudesPendientesPorAutorizarScreen;
