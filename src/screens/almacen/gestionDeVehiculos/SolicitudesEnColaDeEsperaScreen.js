...
const SolicitudesEnColaDeEsperaScreen = () => {
  const [viewData, setViewData] = useState(false);
  const [verificarCompatibilidad, setVerificarCompatibilidad] = useState(false);
...
export default SolicitudesEnColaDeEsperaScreen;
