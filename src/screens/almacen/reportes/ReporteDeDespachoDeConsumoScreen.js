      ...
      <div className="col-lg-12 col-md-12 col-12 mx-auto">
        <div className="multisteps-form__panel border-radius-xl bg-white js-active p-4 position-relative">
          ...
          >
            ...
            <Subtitle mb="3" title="Consecutivo de despacho de consumo" />

            <div className="row">
              <div className="col-12 col-md-3 ms-2">
                <label className="text-terciary ñms-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <DatePicker
                      ...
                      className="form-control border rounded-pill px-3 border border-terciary border border-terciary"
            ...
            {selecOpciones.consecutivo ? (
              <div>
                ...
                <div className="multisteps-form__content">
                  ...
                  <Subtitle mb="3" title="Datos del despacho "  />
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Dependencia</label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                        type="text"
                    ...
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Grupo</label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                        type="text"
                        placeholder="nombre completo"
                ...
                <div className="multisteps-form__content mx-auto">
                  <div className="row mt-3">
                  <Subtitle mb="3" title="Responsable "  />
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Tipo de documento </label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                        type="text"
                        placeholder="nombre completo"
                    ...
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Numero de documento</label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                        type="text"
                        placeholder="nombre completo"
                    ...
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Nombre</label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                        type="text"
                        placeholder="nombre completo"
                ...
                <div className="multisteps-form__content">
                  <div className="row mt-3 ">
                  <Subtitle mb="3" title="Solicitante"  />
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Tipo de documento </label>
                      <input
                        className="form-control border rounded-pill px-3 border border-terciary"
                ...
                <div className="col-12 col-md-12 mt-3 mx-auto">
                ...
                <div className="mt-4 justify-content-end align-items-end">
                  <div className="row">
                    <div className="col-12 col-md-3 ms-2">
                      <label className="text-terciary ñms-2">Nombre quien imprime</label>
                      <input
                ...
                <div className="justify-content-end align-items-end ms-1">
                  <div className="row">
                    <div className="col-12 col-md-3 ms-2">
                      <label  htmlFor="exampleFormControlInput1 mt-4">
                        Fecha de impresion
