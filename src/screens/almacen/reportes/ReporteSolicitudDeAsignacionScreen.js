      ...
      <div className="col-lg-12 col-md-12 col-12 mx-auto">
        <div className="multisteps-form__panel border-radius-xl bg-white js-active p-4 position-relative">
          ...
          >
            ...
            <Subtitle
              title="Consecutivo de solicitud de asigancion de activo"
              mb="3"
            />
            ...
            {selecOpciones.consecutivo ? (
              <div>
                <div className="row">
                  <Subtitle mb="3" mt="3" title="Ubicacion" />
                  <div className="col-12 col-md-3 ms-2">
                ...
                <div className="row">
                  <Subtitle mb="3" mt="3" title="Responsable" />
                  <div className="col-12 col-md-3 ms-2">
                ...
                <div className="row">
                  <Subtitle mb="3" mt="3" title="Operario" />
                  <div className="col-12 col-md-3 ms-2">
                    <label className="text-terciary ms-2">Tipo de documento </label>
                    <input
                      className="form-control border rounded-pill px-3 border border-terciary"
