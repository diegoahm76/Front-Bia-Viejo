...
export const { obtenerBienes,seleccionarBienModel,editarBienAction,crearBienAction } = bienForm.actions;
export default bienForm.reducer

export const obtenerTodosBienes = async (dispatch) => {
    await clienteAxios.get("almacen/bienes/catalogo-bienes/get-list")
        .then((bienes) => {
            dispatch(obtenerBienes(bienes.data))
        }).catch(() => {
            Swal.fire({
                position: "center",
                icon: "error",
...
export const crearBien = async (dispatch, dataBien) => {
    await clienteAxios.post("almacen/bienes/catalogo-bienes/get-list", dataBien).then((res) => {//falta la llamada del servicio
...
export const editarBien = async (dispatch, dataEdit) => {
    ...
    await clienteAxios.put("CatalogoBien", dataModel).then(() => {//cambiar llamado de servicio
