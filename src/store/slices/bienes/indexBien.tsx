...
export const crearBien = async (dispatch, dataBien) => {
    await clienteEstaciones.post("catalogoBienes", dataBien).then((res) => {//falta la llamada del servicio
...
export const editarBien = async (dispatch, dataEdit) => {
    ...
    await clienteEstaciones.put("CatalogoBien", dataModel).then(() => {//cambiar llamado de servicio
