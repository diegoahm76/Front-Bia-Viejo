...
const NotificacionEditar = ({ isModalActive, setIsModalActive }) => {
          ...
          >
            <div className="row">
              <div className="col-12 col-md-12">
                ...
                <input className="col-12 col-md-12" disabled value="Select(T005nombre)"></input>
              </div>
              <div className="col-12 col-md-12">
